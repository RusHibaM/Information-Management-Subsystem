...
<a href="logout.php"><button id="logout" type="button" class="btn btn-success navbar-btn navbar-right">Log out</button></a> 
    ...
    <div class="container">
        <div class="page-header">
            <h1>Group Priviledge</h1>
        </div>

		<form class="form-search" action="modifygroup.php" method="post">
        <table class="table table-bordered">
            ...
            <tbody>	
				<tr class="error" >
                    <td>Student Group</td>
					<td><select name="stu_privlg">
						<option selected="selected" name="stu"></option>
						<option value="1">Select(approved) Quit(approved)</option>
						<option value="2">Select(approved) Quit(denied)  </option>
						<option value="3">Select(denied)   Quit(approved)</option>
						<option value="4">Select(denied)   Quit(denied)  </option>
						</select></td>
				</tr>
				<tr class="error" >
                    <td>Teacher Group</td>
					<td><select name="teac_privlg">
						<option selected="selected" name="teac"></option>
						<option value="1">Select(approved) Quit(approved)</option>
						<option value="2">Select(approved) Quit(denied)  </option>
						<option value="3">Select(denied)   Quit(approved)</option>
						<option value="4">Select(denied)   Quit(denied)  </option>
